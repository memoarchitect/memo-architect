...
const PRESETS: MatrixPreset[] = [
    ...
    },
    {
        ...
        rowKinds: ['SystemRequirement', 'SoftwareRequirement', 'HardwareRequirement'],
        colKinds: ['Test'],
    ...
    },
    {
        ...
        rowKinds: ['UserNeed', 'SystemRequirement', 'SoftwareRequirement'],
        colKinds: ['SystemFunction', 'ComponentFunction'],
    ...
    },
    {
        ...
        rowKinds: ['SystemFunction', 'ComponentFunction'],
