...
import type { ValidationResult, CompletenessReport, Violation } from '@memo/core';
...
const DOC_TYPES: DocType[] = [
    ...
    { id: 'rtm', title: 'Requirements Traceability Matrix', standards: ['IEC 62304:2006 §5.1.1'], layers: ['requirements', 'functional', 'verification'], relevantKinds: ['SystemRequirement', 'SoftwareRequirement', 'DesignInput', 'DesignOutput', 'TestCase', 'VerificationActivity'], group: 'design' },
    ...
    { id: 'dip', title: 'Design Input Plan', standards: ['ISO 13485:2016 §7.3.3'], layers: ['requirements', 'business'], relevantKinds: ['DesignInput', 'SystemRequirement', 'StakeholderNeed', 'UseCase'], group: 'design' },
    ...
    { id: 'labeling', title: 'Labeling Specification', standards: ['21 CFR 801'], layers: ['requirements', 'ui'], relevantKinds: ['LabelingRequirement', 'SystemRequirement'], group: 'compliance' },
