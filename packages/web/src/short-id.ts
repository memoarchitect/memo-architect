...
// a browser). Keep in sync with packages/core/src/model/short-id.ts.
// ─────────────────────────────────────────────────────────────────────────────
...
const KIND_PREFIX_OVERRIDES: Record<string, string> = {
    ...
    StakeholderRequirement: 'STK-REQ', SystemRequirement: 'SYS-REQ',
    SoftwareRequirement: 'SW-REQ', HardwareRequirement: 'HW-REQ',
    SoftwareSpecification: 'SW-SPEC', InterfaceRequirement: 'IF-REQ',
    PerformanceRequirement: 'PERF-REQ', SafetyRequirement: 'SAF-REQ',
    RegulatoryRequirement: 'REG-REQ', FunctionalRequirement: 'FUNC-REQ',
