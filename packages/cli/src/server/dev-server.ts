        ...
        ws.on('message', async (data: any) => {
            try {
                ...
                if (msg.type === 'request:refresh') {
                    ...
                    // Persist ontology selection via two outputs:
                    //   1. SysML v2 import declarations in model/ontology-selection.sysml
                    //      (authoritative SysML-as-source-of-truth; goes through SysML v2 API)
                    //   2. memo.config.yaml / memo.package.yaml updated for the current
                    //      parser pipeline (which reads YAML at startup)
                    const { projectRoot } = options;
                    ...
                    try {
                        ...
                        const sysmlContent = [
                            '// ── Ontology Selection ───────────────────────────────────────────────────────',
                            '//',
                            '// Auto-generated by MEMO when the user saves their ontology selection in the',
                            '// Ontology Viewer. Do not edit manually — use the Ontology Viewer instead.',
                            '//',
                            '// This file is the SysML v2 source-of-truth for which ontology packages are',
                            '// active in this project. Each import declaration brings that ontology\'s',
                            '// namespace into scope for the project\'s model files.',
                            '// ─────────────────────────────────────────────────────────────────────────────',
                            '',
                    ...
                    // ── 2. Update YAML config (keeps parser pipeline working) ──
