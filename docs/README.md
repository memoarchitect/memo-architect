...
| [architecture/reference/sysmlv2-rulebook.md](architecture/reference/sysmlv2-rulebook.md) | Normative SysML v2 authoring rules |
...
| Area | Contents |
|---|---|
| [architecture/](architecture/README.md) | Canonical architecture, rulebook, and reference architecture |
...
- SysML modeling rules live in [architecture/reference/sysmlv2-rulebook.md](architecture/reference/sysmlv2-rulebook.md).
