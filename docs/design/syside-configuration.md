...
3. The config includes both `ontology/` and `examples/gpca-pump/model/` — Syside indexes all 46 `.sysml` files as one model.
...
|-------|------|-----------|
| C1 | Package qualified names are unique across all files | Syside global scope |
