...
6. **Docs in `docs/architecture/reference/`** still reference the pre-replace structure.
...
- Update `docs/architecture/reference/overview.md` and ADRs (especially ADR-1-10) to describe `ontology/` layout + methodology-as-package model.
