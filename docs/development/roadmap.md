...
Reference: CriSys GPCA Project — 86 formal requirements (REQ 1–86), hierarchical state machine (OFF → ON → IDLE/THERAPY → ACTIVE → BASAL/SQUARE BOLUS/PATIENT BOLUS / PAUSED), 20-row notification action table, 5 system interfaces, AADL architectural model, Simulink behavioral model.
