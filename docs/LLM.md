...
3. [decisions/index.md](decisions/index.md) for accepted and superseded ADRs. Pay special attention to:
   ...
   - **ADR-1-17** — three-repo split, **implemented 2026-07-12**: content (`memo`, public mirror `memoarchitect/memo`) ◄ engine (`memo-tools`) ◄ web (`memo-architect`, gitlab `memo-webapp`). The monorepo remains the working checkout; split repos are squashed release cuts.
