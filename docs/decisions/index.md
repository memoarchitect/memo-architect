...
|---|---|---|
| [ADR-1-23](adr/ADR-1-23-explorer-construct-first-grouping.md) | Accepted | Model Explorer groups by ontology domain (architecture/assurance), then SysML construct, then layer, then kind; usages club under their def; relationships and views are not rows |
