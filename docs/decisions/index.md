...
|---|---|---|
| [ADR-1-23](adr/ADR-1-23-explorer-construct-first-grouping.md) | Accepted | Model Explorer groups by ontology domain (architecture/assurance), then layer, then declared kind; the construct decides what is a row, not how the tree is organised |
